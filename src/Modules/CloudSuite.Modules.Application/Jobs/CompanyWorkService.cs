...
{
	public class CompanyWorkService : BackgroundService
	{
        private readonly IServiceProvider _serviceProvider;
        private readonly ILogger<CompanyWorkService> _logger;

        public CompanyWorkService(IServiceProvider serviceProvider, ILogger<CompanyWorkService> logger)
        {
